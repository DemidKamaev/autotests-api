...
Cчитали CSV и сохранили как `DataFrame` - тип данных из библиотеки pandas.

Какие возможности дает `DataFrame`.
...
и мы допустим получит ответ
3474 rows × 12 columns (из 10800 записей общих)
```
...
и в ответе мы получим 1828 rows × 12 columns (из 10800 записей)
```
